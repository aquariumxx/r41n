    ...
    collector.on("collect", async (reaction, user) => {
      ...
      switch (reaction.emoji.name) {
        ...
        case "":
          ...
          const skipembed = new MessageEmbed().setColor("#002EFF").setAuthor(`${user.username} skipped the song.`, "https://cdn.discordapp.com/attachments/748633941912584333/753201474691137647/next.png")
        ...
        case "":
          ...
          if (queue.playing) {
            ...
            const pausemebed = new MessageEmbed().setColor("#002EFF")
            ...
            const playembed = new MessageEmbed().setColor("#002EFF")
        ...
        case "":
          ...
          const loopembed = new MessageEmbed().setColor("#002EFF")
        ...
        case "":
          ...
          if (!canModifyQueue(member)) return;
          queue.songs = [];
          const stopembed = new MessageEmbed().setColor("#002EFF").setAuthor(`${user.username} stopped the music!`, "https://cdn.discordapp.com/emojis/769915194066862080.png")
