...
///////
const persian = [
,'یکار کردی بگم بی تو نمیتونم.'
,'یادته دوسم داشتی؟'
,'من به اندازه‌ی کافی برای عشق تو جنگیدم.'
,'تو نباشی یکی بهتر .'
,'آدمی که بی احساس باشه همیشه برندست🖤.'
,'آروم آروم دارم نشونه‌هاتو از زندگیم کم میکنم.'
,'یە روزی دلت واسم تنگ میشە🌨.'
,'بیا دوبارە خاطرە بسازیم🖤.'
,'زندگیم خیلی قشنگە، البتە بە جز شب هاش..'
,'نیازمند بە یە آدمی کە بهم بگە نترس من باهاتم:)'
,'تو فقط بخند،خودم میشم فدات🗝.'
,'فکر کن من باشم و تو باشی و بارون🌧'
,'کاش میشد از پشت‌‌ گوشی بعضی آدما رو بغل کرد...'
'همە چیز تو بخاطر اون از دست میدی.
,اما در نهایت خود اونم از دست میدی!'
,'کاش یکی مثل خودمو داشتم واسە خودم...'
,'اینایی کە دوستون دارن رو از کجا پیدا میکنید؟'
];
 client.on('message', msg => {
 if (msg.content === ",textpersian") {/////
   msg.channel.send(`${persian[Math.floor(Math.random() * persian.length)]}`);
  }
}); 
///////
