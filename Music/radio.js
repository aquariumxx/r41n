  ...
  async execute(message, args, client) {
    ...
    let resultsEmbed = new Discord.MessageEmbed()
        .setTitle(`**<:emoji_3:815583549326360635> Available Radio Stations**`)//
        .addFields(
          { name: `***<:emoji_3:815583549326360635> Standard Radio***`, value: `**1:  ** [\`${Radiostations[1-1].split(" ")[0]}\`](${Radiostations[1-1].split(" ")[1]})
          ...
          **5:  ** [\`${Radiostations[5-1].split(" ")[0]}\`](${Radiostations[5-1].split(" ")[1]})
          ` , inline: true}, { name: `***<:emoji_3:815583549326360635> Standard Radio***`, value: `**6:  ** [\`${Radiostations[6-1].split(" ")[0]}\`](${Radiostations[6-1].split(" ")[1]})
  ...
  **34: ** [\`${Radiostations[34-1].split(" ")[0]}\`](${Radiostations[34-1].split(" ")[1]})`, inline: true },
  ...
  if(!serverQueue)
  message.channel.send(    new MessageEmbed().setColor("#FF0000")
  .setDescription(`**<:emoji_2:815583500623282207> Joined \`${channel.name}\` 📄 bouned \`#${message.channel.name}\`**`)
  .setFooter(`${message.author.username}#${message.author.discriminator}`));
  //send Search something embed
  message.channel.send(new MessageEmbed().setColor("#FF0000")
  .setDescription(`**<:emoji_6:813090602135584840> Searching <:emoji_1:815583474400493568> \`${Radiostations[i-1].split(" ")[0]}\`**`));
  //mute yourself
